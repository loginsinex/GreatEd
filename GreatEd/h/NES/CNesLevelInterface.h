...
public:
	CNesLevelInterface( CNesMetatiles & mTiles, CNesGameEngineHack & hack, CPaletteBitmap & bm, CNesLevel & level, BYTE uWorldId, BOOL fRenderTitle = FALSE );
	...
	BOOL					SetLevelTitleVisible( BOOL fVisible );
};