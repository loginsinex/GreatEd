...
class CNesTileNCache
{
	...
	CNesBitmap				m_nbmTiles;
	CNesSimpleMMC3			& m_file;

	VOID					InitBitmap();

public:
	CNesTileNCache( CNesSimpleMMC3 & file );
	...
	VOID					DrawTile( CPaletteBitmap & bm, BYTE tile, INT x, INT y, int uReservedSpace ) const;
	VOID					DrawAttribute( CPaletteBitmap & bm, BYTE attr, INT x, INT y, int uReservedSpace ) const;
