...
protected:
	...
	virtual const PVOID		CreateStruct() const;
...
class CWindow
{
	...
	LRESULT				WindowProcDefault(UINT, WPARAM, LPARAM);
...
protected:
	...
	virtual VOID		OnMove( SHORT x, SHORT y );
	...
	INT					MsgBox(LPCTSTR pszText, LPCTSTR pszCaption, UINT uType) const;
	VOID				ShowMessage(LPCTSTR pszText) const;
	VOID				ShowMessageF(LPCTSTR pszText, ...) const;
	VOID				ShowAlert(LPCTSTR pszText) const;
	VOID				ShowAlertF(LPCTSTR pszText, ...) const;
	VOID				ShowError(LPCTSTR pszText) const;
	VOID				ShowErrorF(LPCTSTR pszText, ...) const;
	BOOL				Confirm(LPCTSTR pszText, BOOL fDefaultNo = FALSE) const;
	BOOL				ConfirmF(LPCTSTR pszText, BOOL fDefaultNo, ...) const;
...
public:
	...
	VOID				TitleText( const tstring & sText );
	tstring				TitleText() const;
};
