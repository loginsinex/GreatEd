...
{
	CStaticControl							m_stWorld[ NES_WORLDS_COUNT ];
	CEditControl							m_edWorld[ NES_WORLDS_COUNT ];
	CUpDownControl							m_udWorld[ NES_WORLDS_COUNT ];
...
{
	CStaticControl							m_stZone[ 3 ];
	CControl								m_cbWorld[ 3 ][ 3 ];
