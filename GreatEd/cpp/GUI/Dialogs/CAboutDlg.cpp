...
CAboutDlg::CAboutDlg( HINSTANCE hInstance )
	...
	m_lnk( hInstance, 0x300, WC_LINK, TEXT( "<a href=\"mailto:greated@rail.net.ru\">greated@filezz.net</a>" ), 7, -( 7 + 15 ), 100, 15, WS_TABSTOP | WS_VISIBLE ),
	m_lnkForum( hInstance, 0x301, WC_LINK, TEXT( "<a href=\"http://www.romhacking.net/utilities/1468/\">Check for the latest version</a>" ),
...
BOOL CAboutDlg::OnInit( LPARAM lParam )
{
	...
	m_static.Text( TEXT( "A NES Super Mario Bros I Level Editor\n© Copyright by ALXR, 2021\n\n" ) );
		...
		case 0x300:
			{
				if ( lpnm->code == NM_CLICK || lpnm->code == NM_RETURN )
				{
					...
					ShellExecute( *this, TEXT( "open" ), TEXT( "mailto:greated@filezz.net?subject=GreatEd%20question" ), NULL, NULL, SW_SHOW );
				}
				break;
			}
		case 0x301:
			{
				...
				{
					NMLINK * nml = (NMLINK*)lpnm;
					ShellExecute( *this, TEXT( "open" ), TEXT( "http://www.romhacking.net/utilities/1468/" ), NULL, NULL, SW_SHOW );
				}
				break;
			}
	}
