...
void CScroll::Assign(HWND hWndScroll)
{
	m_hWndScroll = hWndScroll;
	UpdateScroll();
}

void CScroll::ScrollEvent(UINT uMsg, int iScrollEvent)
{
	if ( !m_hWndScroll )
		return;
...
void CScroll::SetScrollArea(int cx, int cy)
{
	RECT rc = { 0 };
...
void CScroll::SetScrollChars(int width, int page)
{
...
void CScroll::ScrollTo(int wcx, int wcy)
{
