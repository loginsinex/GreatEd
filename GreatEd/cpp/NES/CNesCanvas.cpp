...
VOID CNesCanvas::OnEraseBg( HDC hDC )
{
	...
	/*
	if ( m_capture.hilite.fVisible )
	{
		POINT ptHl = { m_capture.hilite.pt.x - left,m_capture.hilite.pt.y - top };
		BitBlt( hDC, ptHl.x, ptHl.y, m_capture.hilite.bmHilite.Width(), m_capture.hilite.bmHilite.Height(),
			m_capture.hilite.bmHilite, 0, 0, SRCCOPY );
	}
	*/
