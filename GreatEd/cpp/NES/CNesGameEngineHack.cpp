...
CNesGameEngineHack::CNesGameEngineHack( CNesSimpleMMC3 & file, CNesPointers & eptr )
...
{
	m_data.coins = m_file.Data<NES_COINS_1UP_WORLD>( m_eptr.Pointer( eCoinsFor1Up ) );
...
{
	m_file.Data<NES_COINS_1UP_WORLD>( m_eptr.Pointer( eCoinsFor1Up ) ) = m_data.coins;
